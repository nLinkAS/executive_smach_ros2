...
class TestStateMachine(unittest.TestCase):
    ...
    def test_sequence(self):
        ...
        with sm:
            ...
            StateMachine.add_auto('SECOND', SimpleActionState(
                self.node, 'fibonacci', Fibonacci, goal=g1), ['succeeded'])
            StateMachine.add('THIRD', SimpleActionState(
                self.node, 'fibonacci', Fibonacci, goal=g1), {'succeeded': 'done'})
